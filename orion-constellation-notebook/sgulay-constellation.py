...
#.scatter(x,y,z) uses "z" as a size measure rather than a third axis.
#looked online but could not figure out the problem.
#perhaps need to uninstall everything (python, miniconda) and re-install?
